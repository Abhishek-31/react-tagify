...
var ReactTags = function (_Component) {
  ...
  _createClass(ReactTags, [{
    ...
    value: function handleKeyDown(e) {
      ...
      if (e.keyCode === _constants.KEYS.UP_ARROW) {
        ...
        this.setState({
          ...
          selectionMode: true,
          val: suggestions[selectedIndex <= 0 ? suggestions.length - 1 : selectedIndex - 1].text
        });
      }
      ...
      if (e.keyCode === _constants.KEYS.DOWN_ARROW) {
        ...
        this.setState({
          ...
          selectionMode: true,
          val: suggestions[suggestions.length === 0 ? -1 : (selectedIndex + 1) % suggestions.length].text
        });
      }
    }
  }, {
    ...
    value: function handleSuggestionHover(i) {
      ...
      this.setState({
        val:this.state.suggestions[i].text,
        selectedIndex: i,
        selectionMode: true
      });
    }
